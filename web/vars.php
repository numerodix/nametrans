<?php 
	$nametrans_terminal_filename = "nametrans-terminal-0.1pre21.zip";
	$nametrans_terminal_filesize = "25kb";

	$nametrans_gui_filename = "nametrans-gui-0.1pre21.zip";
	$nametrans_gui_filesize = "2.3mb";

	$nametrans_wingui_filename = "nametrans-wingui-0.1pre21.zip";
