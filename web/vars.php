<?php 
	$nametrans_terminal_filename = "nametrans-terminal-0.1pre14.zip";
	$nametrans_terminal_filesize = "23kb";

	$nametrans_gui_filename = "nametrans-gui-0.1pre14.zip";
	$nametrans_gui_filesize = "2.3mb";

	$nametrans_guiwin_filename = "nametrans-guiwin-0.1pre14.zip";
